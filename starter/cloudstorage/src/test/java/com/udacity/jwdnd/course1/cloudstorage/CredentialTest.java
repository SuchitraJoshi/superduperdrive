...
class CredentialTest {
    ...
    public void testCreateCredential() {
        ...
        WebElement inputCredUrl = driver.findElement(By.id("note-title"));
        inputCredUrl.click();
        inputCredUrl.sendKeys(getRandomUrl());

        webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("note-description")));
        WebElement inputCredUsername = driver.findElement(By.id("note-description"));
        inputCredUsername.click();
        inputCredUsername.sendKeys(getRandomUsername());

        webDriverWait.until(ExpectedConditions.visibilityOfElementLocated(By.id("note-description")));
        WebElement inputCredPassword = driver.findElement(By.id("note-description"));
        inputCredPassword.click();
        inputCredPassword.sendKeys(getRandomPassword());
